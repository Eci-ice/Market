...
.butt-1 {
  ...
  cursor: pointer; /* 设置悬停时的鼠标样式为手型 */
	...
	<body>
		...
		<div class="login">
			<form action="forgetservlet?method=1" method="post">
				<div class="input">
					<h3>用户${requestScope.forgetname}，请您回答密保问题</h3>
					<h4>${requestScope.forgetquestion}</h4>
					<input type="text" name="getanswer">
					<input type="hidden" name="forname" value="${requestScope.forgetname }">
