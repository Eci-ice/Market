...
.butt-1 {
  ...
  cursor: pointer; /* 设置悬停时的鼠标样式为手型 */
	...
	<body>
		...
		<div class="login">
			<a href="register.jsp?registeruser=0" alt="" title="购买"><button class="butt-1" >我是买家</button></a>
			<a href="register.jsp?registeruser=1" alt="" title="购买"><button class="butt-1" >我是卖家</button></a> 
		</div>
		<div id="b">
