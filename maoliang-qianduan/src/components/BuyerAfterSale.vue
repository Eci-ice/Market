<template>
  ...
  <div class="left">
    ...
    <table class="daohang">
      ...
      <tr>
        <td class="head4">
          <h3
            @click="navigateTo('BuyerShowRecommend')"
            class="head4-1"
            style="cursor: pointer"
          >
            展示推荐商品
        ...
        <td class="head4">
          <h3
            @click="navigateTo('BuyerAfterSale')"
            class="head4-1"
            style="cursor: pointer"
          >
            我的售后
      ...
      <tr>
        <td class="head5">
          <button @click="handleLogout" class="head5-1" style="cursor: pointer">
            退出登录
          </button>
        </td>
      </tr>
  ...
  <div class="right" style="width: 75%">
    <div class="container">
      <router-link :to="{ name: 'BuyerMain' }"> 返回 </router-link>
