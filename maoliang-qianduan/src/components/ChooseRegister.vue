<template>
  <div>
    ...
    <div class="title-container" style="margin-bottom: 10000px;">
      <h2 style="margin-left: 690px;">请您注册！</h2>
      <router-link to="/">返回初始页面</router-link>
    </div>

    <div class="login">
      <router-link :to="{ path: '/register', query: { registeruser: '0' } }">
        <button class="butt-1">我是买家</button>
      </router-link>
      <router-link :to="{ path: '/register', query: { registeruser: '1' } }">
        <button class="butt-1">我是卖家</button>
      </router-link>
    </div>
